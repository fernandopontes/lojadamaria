 ...
 */
class App_ldm_Pagination extends CI_Pagination {
	...
	public $cur_tag_open		= '<li class="active"><a href="#"><strong>';
	public $cur_tag_close		= '</strong></a></li>';
